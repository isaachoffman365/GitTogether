...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function formatDate() {
    var args =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var outputType =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "utc";
    var inputType =
    ...
    if (Array.isArray(args) && args.length > 0 && args[0]) {
      var _args2 = _slicedToArray(args, 6),
        ...
        _date = _args2[2],
        _args2$ = _args2[3],
        hours = _args2$ === undefined ? 0 : _args2$,
        _args2$2 = _args2[4],
        minutes = _args2$2 === undefined ? 0 : _args2$2,
        _args2$3 = _args2[5],
        seconds = _args2$3 === undefined ? 0 : _args2$3;
      if (inputType === "local") {
...
var require_set_contact = __commonJS((exports) => {
  ...
  function setContact(_ref) {
    ...
    if (cutype) {
      formattedParts.push(
        "CUTYPE=".concat((0, _encodeParamValue["default"])(cutype)),
      );
    }
    ...
    if (role) {
      formattedParts.push(
        "ROLE=".concat((0, _encodeParamValue["default"])(role)),
      );
    }
    if (partstat) {
      formattedParts.push(
        "PARTSTAT=".concat((0, _encodeParamValue["default"])(partstat)),
      );
    }
    if (dir) {
      formattedParts.push(
        "DIR=".concat((0, _encodeParamValue["default"])(dir)),
      );
    }
    if (scheduleAgent) {
      formattedParts.push(
        "SCHEDULE-AGENT=".concat(
          (0, _encodeParamValue["default"])(scheduleAgent),
        ),
      );
    }
    formattedParts.push(
      "CN=".concat(
        (0, _encodeParamValue["default"])(name || "Unnamed attendee"),
      ),
    );
    var formattedAttendee = formattedParts
      .join(";")
      .concat(email ? ":mailto:".concat(email) : "");
...
var require_set_organizer = __commonJS((exports) => {
  ...
  function setOrganizer(_ref) {
    ...
    formattedOrganizer += dir
      ? "DIR=".concat((0, _encodeParamValue["default"])(dir), ";")
      : "";
    formattedOrganizer += sentBy
      ? "SENT-BY=".concat(
          (0, _encodeParamValue["default"])("MAILTO:".concat(sentBy)),
          ";",
        )
      : "";
    formattedOrganizer += "CN=";
    formattedOrganizer += (0, _encodeParamValue["default"])(
      name || "Organizer",
    );
...
var require_index_cjs_development = __commonJS((exports, module) => {
  ...
  (function (EnumRunesCode2) {
    EnumRunesCode2[(EnumRunesCode2["HIGH_SURROGATE_START"] = 55296)] =
      "HIGH_SURROGATE_START";
    EnumRunesCode2[(EnumRunesCode2["HIGH_SURROGATE_END"] = 56319)] =
      "HIGH_SURROGATE_END";
    EnumRunesCode2[(EnumRunesCode2["LOW_SURROGATE_START"] = 56320)] =
      "LOW_SURROGATE_START";
    EnumRunesCode2[(EnumRunesCode2["REGIONAL_INDICATOR_START"] = 127462)] =
      "REGIONAL_INDICATOR_START";
    EnumRunesCode2[(EnumRunesCode2["REGIONAL_INDICATOR_END"] = 127487)] =
      "REGIONAL_INDICATOR_END";
    EnumRunesCode2[(EnumRunesCode2["FITZPATRICK_MODIFIER_START"] = 127995)] =
      "FITZPATRICK_MODIFIER_START";
    EnumRunesCode2[(EnumRunesCode2["FITZPATRICK_MODIFIER_END"] = 127999)] =
      "FITZPATRICK_MODIFIER_END";
    EnumRunesCode2[(EnumRunesCode2["VARIATION_MODIFIER_START"] = 65024)] =
      "VARIATION_MODIFIER_START";
    EnumRunesCode2[(EnumRunesCode2["VARIATION_MODIFIER_END"] = 65039)] =
      "VARIATION_MODIFIER_END";
    EnumRunesCode2[(EnumRunesCode2["DIACRITICAL_MARKS_START"] = 8400)] =
      "DIACRITICAL_MARKS_START";
    EnumRunesCode2[(EnumRunesCode2["DIACRITICAL_MARKS_END"] = 8447)] =
      "DIACRITICAL_MARKS_END";
    EnumRunesCode2[(EnumRunesCode2["SUBDIVISION_INDICATOR_START"] = 127988)] =
  ...
  var GRAPHEMES = /* @__PURE__ */ Object.freeze([
  ...
  function isVariationSelector(string) {
    return (
      ...
      betweenInclusive(string.charCodeAt(0), 65024, 65039)
    );
  }
  function isDiacriticalMark(string) {
    return (
      typeof string === "string" &&
      betweenInclusive(string.charCodeAt(0), 8400, 8447)
    );
  }
  function isSupplementarySpecialpurposePlane(string) {
    ...
    return (
      ...
      betweenInclusive(codePoint, 917504, 917631)
    );
  }
  function isGrapheme(string) {
    return (
      typeof string === "string" && GRAPHEMES.includes(string.charCodeAt(0))
    );
  }
...
var require_index_cjs_production_min = __commonJS((exports, module) => {
  var e;
  (function (e2) {
    ((e2[(e2.HIGH_SURROGATE_START = 55296)] = "HIGH_SURROGATE_START"),
      (e2[(e2.HIGH_SURROGATE_END = 56319)] = "HIGH_SURROGATE_END"),
      (e2[(e2.LOW_SURROGATE_START = 56320)] = "LOW_SURROGATE_START"),
      (e2[(e2.REGIONAL_INDICATOR_START = 127462)] = "REGIONAL_INDICATOR_START"),
      (e2[(e2.REGIONAL_INDICATOR_END = 127487)] = "REGIONAL_INDICATOR_END"),
      (e2[(e2.FITZPATRICK_MODIFIER_START = 127995)] =
        "FITZPATRICK_MODIFIER_START"),
      (e2[(e2.FITZPATRICK_MODIFIER_END = 127999)] = "FITZPATRICK_MODIFIER_END"),
      (e2[(e2.VARIATION_MODIFIER_START = 65024)] = "VARIATION_MODIFIER_START"),
      (e2[(e2.VARIATION_MODIFIER_END = 65039)] = "VARIATION_MODIFIER_END"),
      (e2[(e2.DIACRITICAL_MARKS_START = 8400)] = "DIACRITICAL_MARKS_START"),
      (e2[(e2.DIACRITICAL_MARKS_END = 8447)] = "DIACRITICAL_MARKS_END"),
      (e2[(e2.SUBDIVISION_INDICATOR_START = 127988)] =
        "SUBDIVISION_INDICATOR_START"),
      (e2[(e2.TAGS_START = 917504)] = "TAGS_START"),
      (e2[(e2.TAGS_END = 917631)] = "TAGS_END"),
      (e2[(e2.ZWJ = 8205)] = "ZWJ"));
  })(e || (e = {}));
  var n = Object.freeze([
    776, 2359, 2367, 2984, 3007, 3021, 3633, 3635, 3648, 3657, 4352, 4449, 4520,
  ...
  function runes(e2) {
    ...
    for (; t2 < e2.length; )
      ((r += nextUnits(t2 + r, e2)),
        isGrapheme(e2[t2 + r]) && r++,
        isVariationSelector(e2[t2 + r]) && r++,
        isDiacriticalMark(e2[t2 + r]) && r++,
        isZeroWidthJoiner(e2[t2 + r])
          ? r++
          : (n2.push(e2.substring(t2, t2 + r)), (t2 += r), (r = 0)));
    return n2;
  }
  function nextUnits(e2, n2) {
    const t2 = n2[e2];
    if (
      !(function isFirstOfSurrogatePair(e3) {
    ...
    return isRegionalIndicator(r) && isRegionalIndicator(i)
      ? 4
      : (function isSubdivisionFlag(e3) {
            return betweenInclusive(
              codePointFromSurrogatePair(e3),
              127988,
              127988,
            );
          })(r) &&
          (function isSupplementarySpecialpurposePlane(e3) {
            const n3 = e3.codePointAt(0);
            return (
              typeof e3 == "string" &&
              typeof n3 == "number" &&
              betweenInclusive(n3, 917504, 917631)
            );
          })(i)
        ? n2.slice(e2).indexOf(String.fromCodePoint(917631)) + 2
        : (function isFitzpatrickModifier(e3) {
              return betweenInclusive(
                codePointFromSurrogatePair(e3),
                127995,
                127999,
  ...
  function isVariationSelector(e2) {
    return (
      typeof e2 == "string" && betweenInclusive(e2.charCodeAt(0), 65024, 65039)
    );
  }
  function isDiacriticalMark(e2) {
    return (
      typeof e2 == "string" && betweenInclusive(e2.charCodeAt(0), 8400, 8447)
    );
  }
  ...
  function codePointFromSurrogatePair(e2) {
    return (
      ((e2.charCodeAt(0) - 55296) << 10) + (e2.charCodeAt(1) - 56320) + 65536
    );
  }
  ...
  ((function (e2) {
    ((e2[(e2.unit_1 = 1)] = "unit_1"),
      (e2[(e2.unit_2 = 2)] = "unit_2"),
      (e2[(e2.unit_4 = 4)] = "unit_4"));
  })(t || (t = {})),
    Object.defineProperty(runes, "runes", {
      value: runes,
    }),
  ...
  function setTrigger(trigger) {
    ...
    if (
      ...
      formattedString = "TRIGGER;VALUE=DATE-TIME:".concat(
        (0, _encodeNewLines["default"])((0, _formatDate["default"])(trigger)),
        `\r
`,
      );
    } else {
      ...
      formattedString = "TRIGGER:".concat(
        (0, _encodeNewLines["default"])(alert2 + setDuration(trigger)),
        `\r
`,
      );
    }
...
`;
    formattedString +=
      (0, _foldLine["default"])(
        "ACTION:".concat((0, _encodeNewLines["default"])(setAction(action))),
      ) +
      `\r
`;
    formattedString += repeat2
      ? (0, _foldLine["default"])("REPEAT:".concat(repeat2)) +
        `\r
`
      : "";
    formattedString += description
      ? (0, _foldLine["default"])(
          "DESCRIPTION:".concat((0, _encodeNewLines["default"])(description)),
        ) +
        `\r
`
      : "";
...
`
    ...
    formattedString += summary
      ? (0, _foldLine["default"])(
          "SUMMARY:".concat((0, _encodeNewLines["default"])(summary)),
        ) +
        `\r
`
      : "";
...
`;
    icsFormat +=
      (0, _utils.foldLine)(
        "PRODID:".concat((0, _encodeNewLines["default"])(productId)),
      ) +
      `\r
`;
    icsFormat +=
      (0, _utils.foldLine)(
        "METHOD:".concat((0, _encodeNewLines["default"])(method)),
      ) +
      `\r
`;
    icsFormat += calName
      ? (0, _utils.foldLine)(
          "X-WR-CALNAME:".concat((0, _encodeNewLines["default"])(calName)),
        ) +
        `\r
`
      : "";
...
`;
    icsFormat +=
      (0, _utils.foldLine)(
        "UID:".concat((0, _encodeNewLines["default"])(uid)),
      ) +
      `\r
`;
    icsFormat += title
      ? (0, _utils.foldLine)(
          "SUMMARY:".concat(
            (0, _encodeNewLines["default"])((0, _utils.setSummary)(title)),
          ),
        ) +
        `\r
`
    ...
    icsFormat +=
      (0, _utils.foldLine)(
        "DTSTAMP:".concat(
          (0, _encodeNewLines["default"])((0, _utils.formatDate)(timestamp)),
        ),
      ) +
      `\r
`;
...
`,
    ...
    icsFormat += description
      ? (0, _utils.foldLine)(
          "DESCRIPTION:".concat(
            (0, _encodeNewLines["default"])(
              (0, _utils.setDescription)(description),
            ),
          ),
        ) +
        `\r
`
    ...
    icsFormat += url
      ? (0, _utils.foldLine)(
          "URL:".concat((0, _encodeNewLines["default"])(url)),
        ) +
        `\r
`
      : "";
...
`
    ...
    icsFormat += location
      ? (0, _utils.foldLine)(
          "LOCATION:".concat(
            (0, _encodeNewLines["default"])((0, _utils.setLocation)(location)),
          ),
        ) +
        `\r
`
    ...
    icsFormat += status
      ? (0, _utils.foldLine)(
          "STATUS:".concat((0, _encodeNewLines["default"])(status)),
        ) +
        `\r
`
      : "";
    icsFormat += categories
      ? (0, _utils.foldLine)(
          "CATEGORIES:".concat(
            (0, _encodeNewLines["default"])(categories.join(",")),
          ),
        ) +
        `\r
`
...
`
    ...
    icsFormat += busyStatus
      ? (0, _utils.foldLine)(
          "X-MICROSOFT-CDO-BUSYSTATUS:".concat(
            (0, _encodeNewLines["default"])(busyStatus),
          ),
        ) +
        `\r
`
    ...
    icsFormat += transp
      ? (0, _utils.foldLine)(
          "TRANSP:".concat((0, _encodeNewLines["default"])(transp)),
        ) +
        `\r
`
      : "";
    icsFormat += classification
      ? (0, _utils.foldLine)(
          "CLASS:".concat((0, _encodeNewLines["default"])(classification)),
        ) +
        `\r
`
      : "";
    icsFormat += created
      ? "CREATED:" +
        (0, _encodeNewLines["default"])((0, _utils.formatDate)(created)) +
        `\r
`
      : "";
    icsFormat += lastModified
      ? "LAST-MODIFIED:" +
        (0, _encodeNewLines["default"])((0, _utils.formatDate)(lastModified)) +
        `\r
`
      : "";
    icsFormat += htmlContent
      ? (0, _utils.foldLine)(
          "X-ALT-DESC;FMTTYPE=text/html:".concat(
            (0, _encodeNewLines["default"])(htmlContent),
          ),
        ) +
        `\r
`
    ...
    if (attendees) {
      attendees.forEach(function (attendee) {
        icsFormat +=
          (0, _utils.foldLine)(
            "ATTENDEE;".concat(
              (0, _encodeNewLines["default"])((0, _utils.setContact)(attendee)),
            ),
          ) +
          `\r
`;
    ...
    icsFormat += recurrenceRule
      ? (0, _utils.foldLine)(
          "RRULE:".concat((0, _encodeNewLines["default"])(recurrenceRule)),
        ) +
        `\r
`
      : "";
    icsFormat += exclusionDates
      ? (0, _utils.foldLine)(
          "EXDATE:".concat(
            (0, _encodeNewLines["default"])(
              exclusionDates
...
`
    ...
    icsFormat += recurrenceId
      ? (0, _utils.foldLine)(
          "RECURRENCE-ID:".concat(
            (0, _encodeNewLines["default"])(
              (0, _utils.formatDate)(recurrenceId),
            ),
          ),
        ) +
        `\r
...
var require_yup = __commonJS((exports) => {
  ...
  class Condition {
    static fromOptions(refs, config) {
      ...
      return new Condition(refs, (values, schema) => {
        ...
        return (_branch = branch == null ? undefined : branch(schema)) != null
          ? _branch
          : schema;
      });
    }
    ...
    resolve(base, options) {
      let values = this.refs.map((ref) =>
        ref.getValue(
          options == null ? undefined : options.value,
          options == null ? undefined : options.parent,
          options == null ? undefined : options.context,
        ),
      );
  ...
  function createValidation(config) {
    function validate(
      ...
      try {
        ...
        if (
          typeof ((_result = result) == null ? undefined : _result.then) ===
          "function"
        ) {
          if (options.sync) {
            throw new Error(
  ...
  function issuesFromValidationError(error, parentPath) {
    var _error$inner;
    if (
      !((_error$inner = error.inner) != null && _error$inner.length) &&
      error.errors.length
    ) {
...
` +
      ...
      let value =
        rawValue === undefined
          ...
          : this.transforms.reduce(
              (prevValue, fn) =>
                fn.call(this, prevValue, rawValue, this, options),
              rawValue,
            );
      if (value === undefined) {
    ...
    validate(value, options) {
      ...
      let disableStackTrace =
        (_options$disableStack2 =
          options == null ? undefined : options.disableStackTrace) != null
          ? _options$disableStack2
          ...
          .map((fn) => {
            const params =
              fn.OPTIONS.params && options
                ? resolveParams(Object.assign({}, fn.OPTIONS.params), options)
                : fn.OPTIONS.params;
            return {
  ...
  class NumberSchema extends Schema {
    ...
    round(method) {
      ...
      method =
        ((_method = method) == null ? undefined : _method.toLowerCase()) ||
        "round";
  ...
  function sortFields(fields, excludedEdges = []) {
    ...
    return toposort__default["default"]
        ...
        if (field) {
          ...
          fieldValue =
            !options.__validating || !strict
              ? field.cast(inputValue, innerOptions)
              : inputValue;
...
var require_schema = __commonJS((exports) => {
  ...
  function _interopRequireWildcard(e, t) {
    if (typeof WeakMap == "function")
      var r = new WeakMap(),
        n = new WeakMap();
    return (_interopRequireWildcard = function _interopRequireWildcard2(
      e2,
      t2,
    ) {
      ...
      for (var _t in e2)
        _t !== "default" &&
          ...
          ((i =
            ...
            Object.getOwnPropertyDescriptor(e2, _t)) &&
          (i.get || i.set)
            ? o(f, _t, i)
            : (f[_t] = e2[_t]));
      return f;
  ...
  var headerAndEventSchema = yup
    .object()
    .shape(_objectSpread(_objectSpread({}, headerShape), eventShape))
    .test(
      "xor",
      "object should have end or duration (but not both)",
      function (val) {
        var hasEnd = !!val.end;
...
var require_dist2 = __commonJS((exports) => {
  ...
  function _regeneratorRuntime() {
    ...
    function n(r2) {
      ...
      return (
        !!e2 &&
        (e2 === t || (e2.displayName || e2.name) === "GeneratorFunction")
      );
    }
        ...
        (e2 ||
          ((e2 = {
            ...
            delegateYield: function delegateYield(r3, o2, a2) {
              return (
                (e2.resultName = o2),
                t2(n2.d, _regeneratorValues(r3), a2)
              );
            },
          ...
          e2.resultName &&
            ((e2[e2.resultName] = n2.v), (e2.resultName = undefined)),
          (e2.sent = n2.v),
          (e2.next = n2.n));
        try {
    ...
    return (_regeneratorRuntime = function _regeneratorRuntime2() {
      return {
        ...
        async: function async(r2, e2, t2, o2, u) {
          return (n(e2) ? _regeneratorAsyncGen : _regeneratorAsync)(
            a(r2),
            e2,
            t2,
            o2,
  ...
  function _regeneratorKeys(e) {
    ...
    return function e2() {
      for (; r.length; )
        if ((t = r.pop()) in n) return ((e2.value = t), (e2.done = false), e2);
  ...
  function _regeneratorAsyncIterator(t, e) {
    function n(r2, o, i, f) {
      try {
        var c = t[r2](o),
          u = c.value;
        return u instanceof _OverloadYield
          ? e.resolve(u.v).then(
              function (t2) {
                n("next", t2, i, f);
              },
      ...
      return (
        Object.setPrototypeOf
          ...
          : ((e2.__proto__ = GeneratorFunctionPrototype),
            _regeneratorDefine2(e2, o, "GeneratorFunction")),
  ...
  function buildHeaderAndEventAndValidate(event) {
    return (0, _pipeline.validateHeaderAndEvent)(
      _objectSpread(
        _objectSpread({}, (0, _pipeline.buildHeader)(event)),
        (0, _pipeline.buildEvent)(event),
      ),
    );
  }
  ...
  function createEvents(events, headerAttributesOrCb, cb) {
    var resolvedHeaderAttributes =
      _typeof(headerAttributesOrCb) === "object" ? headerAttributesOrCb : {};
    var resolvedCb =
      arguments.length === 3
        ? cb
        : typeof headerAttributesOrCb === "function"
          ? headerAttributesOrCb
          : null;
    var run = function run2() {
      ...
      var _ref =
          events.length === 0
            ...
            : buildHeaderAndEventAndValidate(
                _objectSpread(
                  _objectSpread({}, events[0]),
                  resolvedHeaderAttributes,
                ),
              ),
  ...
  function _createEventsAsync() {
    _createEventsAsync = _asyncToGenerator(
      /* @__PURE__ */ _regeneratorRuntime().mark(function _callee2(events) {
                ...
                case 0:
                  headerAttributes =
                    _args2.length > 1 && _args2[1] !== undefined
                      ...
                      : {};
                  tick =
                    typeof (globalThis === null || globalThis === undefined
                      ? undefined
                              ...
                              switch ((_context.prev = _context.next)) {
                                ...
                                case 2:
                                  ((_ref3 =
                                    ...
                                    (headerError = _ref3.error),
                                    (headerValue = _ref3.value));
                                  if (!headerError) {
                                    _context.next = 5;
                                    break;
                                  }
                                ...
                                case 5:
                                  parts = [
                                    (0, _pipeline.formatHeader)(headerValue),
                                  ];
                                  yieldEvery = 1000;
                                  i = 0;
                                case 8:
                                  ...
                                  ((_buildHeaderAndEventA2 =
                                    buildHeaderAndEventAndValidate(events[i])),
                                    (eventError = _buildHeaderAndEventA2.error),
                                    (eventValue =
                                      _buildHeaderAndEventA2.value));
                                  if (!eventError) {
                                    _context.next = 12;
                                    break;
                                  }
                                ...
                                case 12:
                                  parts.push(
                                    (0, _pipeline.formatEvent)(eventValue),
                                  );
...
var dateInTimeZone = function (date, timeZone) {
  ...
  var dateInTargetTZ = new Date(
    dateTZtoISO8601(
      date,
      timeZone !== null && timeZone !== undefined ? timeZone : "UTC",
    ),
  );
...
totext_default.IMPLEMENTED[Frequency.YEARLY] = ["byweekno", "byyearday"].concat(
  common,
);
...
var DateTime = (function (_super) {
  ...
  DateTime2.prototype.addMinutes = function (
    minutes,
    filtered,
    byhour,
    byminute,
  ...
  DateTime2.prototype.addSeconds = function (
    seconds,
    filtered,
    byhour,
    byminute,
            ...
            __spreadArray(
              __spreadArray(
                __spreadArray(
                  __spreadArray(
                    __spreadArray(
                      __spreadArray(__spreadArray([], NM31, true), NM29, true),
                      NM31,
                      true,
                    ),
                    NM30,
            ...
            __spreadArray(
              __spreadArray(
                __spreadArray(
                  __spreadArray(
                    __spreadArray(
                      __spreadArray(__spreadArray([], NM31, true), NM28, true),
                      NM31,
                      true,
                    ),
                    NM30,
...
var RRule = (function () {
  ...
  RRule2.prototype.between = function (after, before, inc, iterator) {
    ...
    if (iterator) {
      return this._iter(
        new callbackiterresult_default("between", args, iterator),
      );
    }
